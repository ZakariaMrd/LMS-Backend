...
<a href="{{ url('/') }}" class="btn btn-danger" style="margin-left:1140px; margin-top:14px;">Go to User Panel</a>
    ...
    <h1><span style="color:#00FFFF;">Library</span><br><span style="color:;">Library </span><br> <span style="color:#000000;"> Management </span> <br><span style="color:#6495ED;"> System</span></h1>
